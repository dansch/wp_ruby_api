...
* Install the {link JSON-API plugin}[http://wordpress.org/extend/plugins/json-api/] in your wordpress blog
* {link HTTParty}[http://rubygems.org/gems/httparty] gem must be installed
